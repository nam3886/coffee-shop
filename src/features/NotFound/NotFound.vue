<template>
  <div class="d-none">
    <div class="bg-primary border-bottom p-3 d-flex align-items-center mb-4">
      ...
      <h4 class="font-weight-bold m-0 text-white">Trang không tìm thấy</h4>
    </div>
  </div>
  <div
  ...
  >
    <div class="osahan-text text-center">
      ...
      <h2 class="text-primary mb-3 font-weight-light">
        Không thể tìm thấy <b>trang</b>
      </h2>
      <p class="lead small mb-0">
        Ôi!!! Có vẻ như có vấn đề gì đó với kết nối mạng của bạn
      </p>
      <p class="mb-5">
        Nếu bạn nghĩ vấn đề là từ chúng tôi, Xin hãy
        <a href="#">liên hệ chúng tôi</a>.
      </p>
      <a href="home.html" class="btn btn-primary">Quay về</a>
      <a href="faq.html" class="btn btn-light">Trợ giúp</a>
    </div>
  </div>
</template>
