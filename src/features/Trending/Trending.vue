<template>
  <div class="d-none">
    <div class="bg-primary p-3 d-flex align-items-center">
      ...
      <h4 class="font-weight-bold m-0 text-white">Đang thịnh hành</h4>
    </div>
  </div>
    ...
    <div class="container">
      <div class="most_popular py-5">
        <div class="d-flex align-items-center mb-4">
          <h3 class="font-weight-bold text-dark mb-0">Đang thịnh hành</h3>
          <a
            href="#"
            data-toggle="modal"
            data-target="#filters"
            ...
            >
              ...
              <div class="p-3 position-relative">
                <div class="list-card-body">
                  <h6 class="mb-1">
                    <a href="restaurant.html" class="text-black">Trà đào </a>
                  </h6>
          ...
          <div class="col-lg-4 mb-3">
            ...
            >
              ...
              <div class="p-3 position-relative">
                <div class="list-card-body">
                  <h6 class="mb-1">
                    <a href="restaurant.html" class="text-black">Trà tắc</a>
                  </h6>
                  <p class="text-gray mb-3"></p>
                  <p class="text-gray mb-3 time">
                    <span
                      class="bg-light text-dark rounded-sm pl-2 pb-1 pt-1 pr-2"
                      ><i class="feather-clock"></i> 30–35 phút</span
                    >
          ...
          <div class="col-lg-4 mb-3">
            ...
            >
              ...
              <div class="p-3 position-relative">
                <div class="list-card-body">
                  <h6 class="mb-1">
                    <a href="restaurant.html" class="text-black">Capucchino </a>
                  </h6>
                  <p class="text-gray mb-3"></p>
                  <p class="text-gray mb-3 time">
                    <span
